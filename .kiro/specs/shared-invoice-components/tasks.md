...
- [x] 1. Create shared types and utility modules
  - [x] 1.1 Create `libs/shared/ui/src/types/invoice.types.ts`
  ...
  - [x] 1.2 Create `libs/shared/ui/src/types/currency.types.ts`
  ...
  - [x] 1.3 Create `libs/shared/ui/src/utils/formatDate.ts`
  ...
  - [x] 1.4 Create barrel exports for types and utils
...
- [x] 2. Migrate common components to the shared library
  - [x] 2.1 Create `libs/shared/ui/src/components/common/StatCard.tsx`
  ...
  - [x] 2.2 Create `libs/shared/ui/src/components/common/PartyInfoCard.tsx`
  ...
  - [x] 2.3 Create `libs/shared/ui/src/components/common/LineItemsDetailTable.tsx`
    - Copy from `apps/inventory/src/app/components/common/LineItemsDetailTable.tsx`
    - Verify no app-specific imports remain
    - _Requirements: 3.1_

  - [x] 2.4 Create `libs/shared/ui/src/components/common/TaxSummaryCollapsible.tsx`
  ...
  - [x] 2.5 Create `libs/shared/ui/src/components/common/index.ts` barrel export
...
- [x] 4. Migrate simple presentational invoice components
  - [x] 4.1 Create `libs/shared/ui/src/components/invoice/InvoiceStatusBadge.tsx`
    - Copy from inventory app
    - Update `InvoiceStatus` import to `../../types/invoice.types`
    - Update `Badge` import to shared UI path
    - _Requirements: 1.1, 8.1_

  - [x] 4.2 Create `libs/shared/ui/src/components/invoice/InvoiceHeader.tsx`
    - Copy from inventory app
    - Update `Invoice` type import to shared lib types
    - _Requirements: 1.1, 8.1_

  - [x] 4.3 Create `libs/shared/ui/src/components/invoice/InvoiceDates.tsx`
    - Copy from inventory app
    - Update `formatDate` import to `../../utils/formatDate`
    - Update `Invoice` type import to shared lib types
    - _Requirements: 1.1, 4.5, 8.1_

  - [x] 4.4 Create `libs/shared/ui/src/components/invoice/InvoicePartyInfo.tsx`
    - Copy from inventory app
    - Update `PartyInfoCard` import to `../common/PartyInfoCard`
    - Update `Invoice` type import to shared lib types
    - _Requirements: 1.1, 8.1_

  - [x] 4.5 Create `libs/shared/ui/src/components/invoice/InvoiceAmountsSummary.tsx`
    - Copy from inventory app
    - Update `Invoice` type import to shared lib types
    - _Requirements: 1.1, 8.1_

  - [x] 4.6 Create `libs/shared/ui/src/components/invoice/InvoiceStats.tsx`
    - Copy from inventory app
    - Update `StatCard` import to `../common/StatCard`
    - _Requirements: 1.1, 4.6, 8.1_

  - [x] 4.7 Create `libs/shared/ui/src/components/invoice/InvoiceManagementHeader.tsx`
    - Copy from inventory app
    - Update `Button` and `cn` imports to shared UI paths
    - _Requirements: 1.1, 8.1_

  - [x] 4.8 Create `libs/shared/ui/src/components/invoice/SendInvoiceEmailDialog.tsx`
    - Copy from inventory app
    - Update `Invoice` type import to shared lib types
    - _Requirements: 1.1, 8.1_

- [x] 5. Migrate components requiring props decoupling
  - [x] 5.1 Create `libs/shared/ui/src/components/invoice/InvoiceContent.tsx`
    - Copy from inventory app
  ...
  - [x] 5.2 Create `libs/shared/ui/src/components/invoice/BankAccountDetails.tsx`
    - Copy from inventory app
  ...
  - [x] 5.3 Create `libs/shared/ui/src/components/invoice/InvoiceLineItemTable.tsx`
    - Copy from inventory app
  ...
  - [x] 5.4 Create `libs/shared/ui/src/components/invoice/InvoicesTable.tsx`
    - Copy from inventory app
  ...
  - [x] 5.5 Create `libs/shared/ui/src/components/invoice/InvoiceManagementFilters.tsx`
    - Copy from inventory app
  ...
  - [x] 5.6 Create `libs/shared/ui/src/components/invoice/InvoiceDetailDialog.tsx`
    - Copy from inventory app
  ...
  - [x] 5.7 Create `libs/shared/ui/src/components/invoice/InvoiceDialog.tsx`
    - Copy from inventory app
...
- [x] 6. Create invoice barrel export and wire into shared library
  - [x] 6.1 Create `libs/shared/ui/src/components/invoice/index.ts`
  ...
  - [x] 6.2 Update `libs/shared/ui/src/components/index.ts`
...
- [x] 8. Update the inventory app to consume from the shared library
  - [x] 8.1 Update `InvoiceManagement.tsx` orchestrator imports
  ...
  - [x] 8.2 Update inventory app type imports
  ...
  - [x] 8.3 Update `RevenuePage.tsx` lazy import
  ...
  - [x] 8.4 Update any other inventory app files importing from old paths
  ...
  - [x] 8.5 Clean up old inventory app invoice component files
