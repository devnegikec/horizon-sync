...
export function StatusAlert({ message, variant, 'data-testid': testId }: StatusAlertProps) {
  ...
  return (
    <div className={`flex items-center gap-2 p-3 rounded-lg border ${styles}`} role="alert" data-testid={testId}>
