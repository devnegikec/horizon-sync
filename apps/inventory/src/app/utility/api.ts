...
export const stockLevelApi = {
  list: (
    ...
    page = 1,
    pageSize = 20,
    filters?: { warehouse_id?: string; item_id?: string }
  ) =>
...
export const stockMovementApi = {
  ...
  get: (accessToken: string, id: string) =>
    apiRequest(`/stock-movements/${id}`, accessToken),
...
export const stockEntryApi = {
  list: (
    ...
    page = 1,
    pageSize = 20,
    filters?: { stock_entry_type?: string; status?: string }
  ) =>
...
export const itemSupplierApi = {
  list: (
    ...
    page = 1,
    pageSize = 20,
    filters?: { item_id?: string; supplier_id?: string }
  ) =>
